...
(function() {
  ...
  document.getElementById('body').classList.add('no-touch');
  window.addEventListener('touchstart', function() {
    document.getElementById('body').classList.remove('no-touch');
    document.getElementById('body').classList.add('touch');
  });

  // Use tooltip fallback mode on IE < 11.
  if (bowser.msie && parseFloat(bowser.version) < 11) {
    document.getElementById('body').classList.add('tooltip-fallback');
  }
  ...
  if (screenfull.enabled && data.settings.fullscreenButton) {
    document.getElementById('body').classList.add('fullscreen-enabled');
    ...
    document.getElementById('body').classList.add('fullscreen-disabled');
  }
