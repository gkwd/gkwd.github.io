...
var p = document.getElementById("particales_block");
...
function init() {
  ...
  if (canvas && canvas.getContext) {
    ...
    p.addEventListener("mousemove", documentMouseMoveHandler, false);
    p.addEventListener("mousedown", documentMouseDownHandler, false);
...
function createParticles() {
  ...
  for (var i = 0; i < QUANTITY; i++) {
    var particle = {
      ...
      speed: 0.051 + Math.random() * 0.04,
      targetSize: 1,
      fillColor: FILL_COLOR, // "#36af57", //+ // (Math.random() * 0x404040 + 0xaaaaaa | 0).toString(16),
...
let t = document.querySelector(".glg-title");
